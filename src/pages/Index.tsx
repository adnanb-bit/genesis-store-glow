          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 rounded-2xl bg-muted/50 animate-fade-in">
                ...
                <h3 className="font-heading text-xl mb-2">Therapeutic & Fun</h3>
              ...
              <div className="text-center p-6 rounded-2xl bg-muted/50 animate-fade-in" style={{ animationDelay: "0.1s" }}>
                ...
                <h3 className="font-heading text-xl mb-2">Pride in Creating</h3>
                <p className="text-muted-foreground">
              ...
              <div className="text-center p-6 rounded-2xl bg-muted/50 animate-fade-in" style={{ animationDelay: "0.2s" }}>
                ...
                <h3 className="font-heading text-xl mb-2">Beautiful Home Decor</h3>
                <p className="text-muted-foreground">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start gap-4 p-4 bg-card rounded-xl border border-border">
                  ...
                  <div>
                    <h3 className="font-heading text-lg mb-1">All Materials Included</h3>
                ...
                <div className="flex items-start gap-4 p-4 bg-card rounded-xl border border-border">
                  ...
                  <div>
                    <h3 className="font-heading text-lg mb-1">Printed Tutorial Guide</h3>
                    <p className="text-muted-foreground text-sm">
                ...
                <div className="flex items-start gap-4 p-4 bg-card rounded-xl border border-border">
                  ...
                  <div>
                    <h3 className="font-heading text-lg mb-1">Video Tutorial Access</h3>
                    <p className="text-muted-foreground text-sm">
                ...
                <div className="flex items-start gap-4 p-4 bg-card rounded-xl border border-border">
                  ...
                  <div>
                    <h3 className="font-heading text-lg mb-1">Support & Community</h3>
                    <p className="text-muted-foreground text-sm">
