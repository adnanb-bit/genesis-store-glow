      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <h1 className="font-heading font-extrabold text-stroke-bold text-2xl mb-4">Product not found</h1>
            <Button asChild>
              <Link to="/shop">
      ...
      <main className="flex-1 py-8 md:py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            {/* Product Info */}
            <div>
              <h1 className="font-heading font-extrabold text-stroke-bold text-3xl md:text-4xl text-foreground mb-4">
                {product.title}
              </h1>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {option.values.map((value, valueIndex) => (
                          <Button
                            key={value}
                            variant={
                              product.variants.edges[selectedVariantIndex]?.node.selectedOptions.find(
              ...
              <div className="bg-muted/50 rounded-xl p-6">
                <h3 className="font-heading font-extrabold text-stroke-bold text-lg mb-4">What's Included</h3>
