      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-peach/30 to-background py-12 md:py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="font-heading font-extrabold text-stroke-bold text-4xl md:text-5xl text-primary mb-4">
              Shop DIY Kits
            </h1>
          ...
          <div className="container mx-auto px-4">
            {loading ? (
              ...
              <div className="text-center py-20 bg-muted/30 rounded-2xl">
                ...
                <h2 className="font-heading font-extrabold text-stroke-bold text-2xl mb-3">No products found</h2>
