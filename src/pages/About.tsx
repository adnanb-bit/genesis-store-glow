        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <h2 className="font-heading font-extrabold text-3xl text-foreground mb-6 text-center">
                Why BulBul?
              </h2>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="font-heading font-extrabold text-lg mb-2">Made with Love</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-heading font-extrabold text-lg mb-2">Creativity for All</h3>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="font-heading font-extrabold text-lg mb-2">Community</h3>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="font-heading font-extrabold text-lg mb-2">Quality First</h3>
                <p className="text-muted-foreground text-sm">
        ...
        <section className="py-16 md:py-24 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-heading font-extrabold text-3xl md:text-4xl text-center text-foreground mb-6">
                The Joy of Creating
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-muted/50 rounded-xl p-6">
                  <h3 className="font-heading font-extrabold text-lg mb-2">Stress Relief</h3>
                ...
                <div className="bg-muted/50 rounded-xl p-6">
                  <h3 className="font-heading font-extrabold text-lg mb-2">Sense of Achievement</h3>
                  <p className="text-muted-foreground">
                ...
                <div className="bg-muted/50 rounded-xl p-6">
                  <h3 className="font-heading font-extrabold text-lg mb-2">Screen-Free Time</h3>
                  <p className="text-muted-foreground">
                ...
                <div className="bg-muted/50 rounded-xl p-6">
                  <h3 className="font-heading font-extrabold text-lg mb-2">Personal Expression</h3>
                  <p className="text-muted-foreground">
